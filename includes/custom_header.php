...
// আপনার দেওয়া URL অনুযায়ী সংশোধন করা হলো
...
// --------------------------------------------------------
// ✅ C. NEW: Update Last Activity Time 
// --------------------------------------------------------
...
if (isset($_SESSION['user_id'])) {
    ...
    // যদি কোনো Active Session না পাওয়া যায় (অর্থাৎ অ্যাডমিন ফোর্স লগআউট করেছে)
...
/* ===== Submenu Styling (Updated Spacing & Visual Clarity) ===== */
        .has-submenu {
            margin-bottom: 8px; /* প্রতিটি dropdown মেনুর মাঝে ফাঁকা জায়গা */
        }
        ...
        .has-submenu .submenu {
            ...
            list-style: none;
            padding-left: 25px;
            margin: 8px 0 10px 0; /* ওপরে-নিচে কিছু ফাঁকা জায়গা */
        }
        ...
        .radio-group {
            display: flex;
            gap: 20px; /* অপশনগুলোর মধ্যে কিছুটা ফাঁকা জায়গা দেবে */
            margin-top: 5px;
        }
        ...
        .radio-option input[type="radio"] {
            /* এটি নিশ্চিত করবে যে বাটনটি টেক্সটের সাথে অ্যালাইন হয়েছে */
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <?php endif; ?>
                            <li><a href="<?php echo BASE_PATH; ?>pages/my_doctors.php"><i class="fa-solid fa-user-doctor"></i> My Doctor List</a></li>
